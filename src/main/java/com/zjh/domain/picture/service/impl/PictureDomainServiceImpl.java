package com.zjh.domain.picture.service.impl;
...
import com.zjh.infrastructure.utils.ColorSimilarUtils;
import com.zjh.interfaces.dto.picture.*;
import com.zjh.interfaces.vo.picture.PictureVO;
import com.zjh.infrastructure.manager.upload.FilePictureUpload;
import com.zjh.infrastructure.manager.upload.PictureUploadTemplate;
import com.zjh.infrastructure.manager.upload.UrlPictureUpload;
...
//        checkPictureAuth(loginUser, picture);
    ...
    public void checkPictureAuth(User loginUser, Picture picture){
        ...
        if (spaceId == null){
            //仅本人和管理员可以操作
            if(!id.equals(userId) && !loginUser.isAdmin()){
                throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
            }
        }else {
